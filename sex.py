...
API_ID = 39496551            # <-- APNA API_ID DALO API_HASH = "36495414098630fed4555734bcc9748b"   # <-- APNA API_HASH DALO SESSION = "clonify" DOWNLOAD_DIR = "downloads"
...
if name == "main": print("Userbot started successfully") app.run()
